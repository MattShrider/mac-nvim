...
-- telescope
keymap.set("n", "<leader>fu", "<cmd>Telescope undo<cr>") -- find files within current working directory, respects .gitignore
...
keymap.set("n", "<leader>gs", "<cmd>Git<cr>") -- list current changes per file with diff preview ["gs" for git status]
