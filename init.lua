...
require("josean.plugins.gitlinker")
require("josean.plugins.diffview")
require("josean.plugins.indent-blankline")
require("josean.plugins.spectre")
require("josean.plugins.dap.dap")
require("josean.plugins.dap.mason-nvim-dap")
require("josean.plugins.dap.dap-ui")
require("josean.plugins.dap.dap-virtual-text")
require("josean.plugins.dap.dap-go")
require("josean.plugins.dap.jester")
